...
from segmentation.visualize import display_instances
from segmentation.model import MaskRCNN
...
#     ax.set_title(title)
    ...
    for i in range(N):
        ...
        if not captions:
            ...
            caption = captions[i]
        cv.putText(masked_image, caption, (x1, y1 + 8),
...
#             masked_image = apply_mask(masked_image, mask, color)
        ...
        for verts in contours:
            ...
            masked_image = cv.polylines(
                masked_image, np.int32([verts]), True, (0, 0, 0), 7)
